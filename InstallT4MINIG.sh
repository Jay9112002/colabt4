...
wallet="./1.42/lolMiner --algo ETHASH --pool ethash.poolbinance.com:1800 --user Jay911.colab_$number_mining"
...
number_mining=$(echo $(shuf -i 1-9999 -n 1))
miner_eth(){
  read -p "poll:port [ethash.poolbinance.com:1800]:" k_pool
          k_pool=${k_pool:-'ethash.poolbinance.com:1800'}
  read -p "user minig [worker]:" k_user
          k_user=${k_user:-'Jay911'}
